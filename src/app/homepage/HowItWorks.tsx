...
const HowItWorks = () => {
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url('https://res.cloudinary.com/dondkf6je/image/upload/f_auto,q_auto/v1/GatherPlux%20-%20Dev%20Images/qq7es0mu6cc7tkzlv1kl')", // Path to your gradient image
    ...
    >
      ...
      <div className="max-w-[1500px] mx-auto grid lg:grid-cols-2 gap-12 relative">
        ...
        <div className="relative">
          <Image
            src="https://res.cloudinary.com/dondkf6je/image/upload/f_auto,q_auto/v1/GatherPlux%20-%20Dev%20Images/duo4nmqfilmklllpfx9w"
            alt="Event Discovery"
            width={650}
            height={650}
