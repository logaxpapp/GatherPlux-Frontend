  ...
  return (
    <div className="bg-[#020e1e]">
      <div className="flex bg-[#020e1e] min-h-screen mx-auto max-w-6xl pt-32">
            {/* Sidebar */}
            <div className="bg-[#020e1e] p-6 border-r border-gray-700">
          ...
          <ul className="space-y-4">
            ...
            <li
              className={`cursor-pointer flex items-center space-x-2 text-white px-4 py-2 rounded-md ${
                pathname === "/profile/password" ? "bg-[#243447]" : "hover:bg-[#243447]"
              } transition duration-200 text-sm`}
            ...
            <li
              className={`cursor-pointer flex items-center space-x-2 text-white px-4 py-2 rounded-md ${
                pathname === "/profile/bookings" ? "bg-[#243447]" : "hover:bg-[#243447]"
              } transition duration-200 text-sm`}
            ...
            <li
              className={`cursor-pointer flex items-center space-x-2 text-white px-4 py-2 rounded-md ${
                pathname === "/profile/bookmark" ? "bg-[#243447]" : "hover:bg-[#243447]"
              } transition duration-200 text-sm`}
