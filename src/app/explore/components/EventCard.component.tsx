  ...
  return (
    <div className="bg-[#1C2B37] p-4 rounded-md flex items-center space-x-4 w-[610px] h-[228px]">
      <div className="relative">
        <img src="https://i.pinimg.com/736x/4b/92/43/4b924325613089a96886f1f64ce6d657.jpg" alt="Event Image" className="rounded-md w-[300px] h-[180px]" />
        <span className="bg-[#9EDD45] px-2 rounded-md text-black absolute bottom-0 left-0">Music & Concert</span>
      </div>
      <div>
        <h3 className="font-semibold text-[20px]">Event title that can go up to two lines</h3>
