  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Heading */}
        <h2 className="text-2xl sm:text-3xl font-bold text-center">Forgot password</h2>
        ...
        <div className="mt-4 text-center">
          <Link href="/auth/login" className="text-[#9EDD45] hover:underline flex items-center justify-center text-sm sm:text-base">
