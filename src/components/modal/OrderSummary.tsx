...
import { FaLock } from "react-icons/fa"; // Import the padlock 
        ...
        <div className="max-w-md w-full bg-[#1b2634] text-white rounded-lg shadow-lg border border-[#89E101] p-4">
          ...
          <div className="mt-4 px-4 text-sm">
            ...
            <div className="flex justify-between font-semibold text-base mt-2">
              ...
              <span className="text-[#89E101]">₦211.80</span>
            </div>
          </div>

        {/* Pay Now Button */}
        <button className="w-full mt-4 bg-[#9edd45] text-black font-semibold py-2 rounded-md text-center hover:bg-[#7AC801] inline-flex items-center justify-center gap-2">
            <FaLock /> {/* Padlock Icon */}
            Pay Now
          </button>
        </div>
